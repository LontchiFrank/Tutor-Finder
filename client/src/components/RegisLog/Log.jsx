            ...
            <div className="tablet-txt">
              ...
              <div className="txt-1">
                <p className=" text-muted mb-0 ">
                  Sign in and discover great tutors and fascinating lessons!
                </p>
              </div>
          ...
          <div className="pad-form1">
            ...
            <form onSubmit={onSubmit}>
              <div className="row">
                ...
                <p className="parag">
                  Sign in and discover tutors that suits your learning
                  abilities!<Link to="/register">Register</Link>
                </p>
              </div>
            </form>
          </div>
